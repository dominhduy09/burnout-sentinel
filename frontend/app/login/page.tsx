  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-5 py-10 text-slate-900 sm:px-6 lg:px-10">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-24 top-16 h-80 w-80 rounded-full bg-sky-300/28 blur-3xl" />
      ...
      <div className="relative mx-auto w-full max-w-5xl">
        <div className="relative overflow-hidden rounded-[34px] border border-white/65 bg-white/22 shadow-[0_38px_90px_rgba(15,23,42,0.18)] backdrop-blur-2xl">
          ...
          <div className="grid gap-0 lg:grid-cols-[1fr_1fr]">
            <section className="relative border-b border-white/50 bg-[linear-gradient(145deg,_rgba(16,185,129,0.18)_0%,_rgba(59,130,246,0.16)_56%,_rgba(255,255,255,0.12)_100%)] px-6 py-7 sm:px-8 sm:py-8 lg:border-b-0 lg:border-r lg:border-white/50 lg:px-9 lg:py-10">
              <p className="eyebrow">Liquid Glass Session</p>
              <h1 className="mt-3 text-balance text-3xl font-semibold tracking-tight text-ink sm:text-[2.1rem]">
                Welcome back to your calm control room
              </h1>
              <p className="mt-4 max-w-md text-sm leading-6 text-slate-700 sm:text-[15px]">
                Login keeps your planning experience personal with a secure cookie session and zero setup friction.
              </p>

              <div className="mt-7 space-y-3">
                <div className="glass-pill w-fit text-xs text-emerald-900">Session cookie stored securely</div>
                <div className="glass-pill w-fit text-xs text-sky-900">Fast sign-in with name and email</div>
                <div className="glass-pill w-fit text-xs text-amber-900">Logout anytime from home screen</div>
              </div>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-2.5">
                ...
                <Link
                  href="/signup"
                  className="glass-button inline-flex items-center justify-center rounded-full border border-sky-200/70 bg-[linear-gradient(135deg,_rgba(255,255,255,0.85)_0%,_rgba(239,246,255,0.72)_100%)] px-4 py-2 text-sm font-semibold text-sky-900"
                >
                  Create account
                </Link>
              </div>
            ...
            <section className="relative p-6 sm:p-8 lg:p-9">
              ...
              <form onSubmit={onSubmit} className="relative space-y-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="glass-button inline-flex w-full items-center justify-center rounded-full border border-emerald-200/70 bg-[linear-gradient(135deg,_rgba(16,185,129,0.95)_0%,_rgba(14,165,233,0.9)_100%)] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_14px_34px_rgba(16,185,129,0.24)] transition hover:shadow-[0_18px_40px_rgba(14,165,233,0.28)] disabled:cursor-not-allowed disabled:opacity-70"
                >
                ...
                <p className="pt-1 text-center text-xs text-slate-600">
                  New here?{" "}
                  <Link href="/signup" className="font-semibold text-emerald-700 underline decoration-emerald-300/80 underline-offset-2">
                    Sign up
                  </Link>
                </p>
              </form>
